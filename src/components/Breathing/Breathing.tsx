...
//     }
//     55% {
//       background: radial-gradient(circle, rgba(227, 180, 171, 1) 40%, rgba(246, 197, 156, 1) 70%);
//     }
//     60% {
//       background: radial-gradient(circle, rgba(227, 180, 171, 1) 25%, rgba(246, 197, 156, 1) 75%);
//     }
//     65% {
//       background: radial-gradient(circle, rgba(227, 180, 171, 1) 15%, rgba(246, 197, 156, 1) 85%);
//     }
//     70% {
//       background: radial-gradient(circle, rgba(227, 180, 171, 1) 5%, rgba(246, 197, 156, 1) 95%);
//     }
//     75% {
//       background: radial-gradient(circle, rgba(227, 180, 171, 1) 2%, rgba(246, 197, 156, 1) 98%);
//     }
//     100% {
//       background: radial-gradient(circle, rgba(227, 180, 171, 1) 1%, rgba(246, 197, 156, 1) 99%);
//     }
//   }
// `;
